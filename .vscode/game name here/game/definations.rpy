...
define npc_glasses = Character("戴著眼鏡的學生")
...
default a_love = 0
default b_love = 0
default a_tellingname = 0
default day2_count = 0
default sportfield_reacted = 0
default library_reacted = 0
default go_around_reacted = 0
default repeat = 0
